 ...
 * Examples:
 *   /api/v1/users/orders
 *   /api/v1/users/orders?page=2&limit=20
 *   /api/v1/users/orders?status=pending
 *   /api/v1/users/orders?page=1&limit=10&status=completed
 * 
 * Response:
 *   {
 *     "success": true,
...
3. Get orders (page 1, 10 per page):
   GET /api/v1/users/orders
   GET /api/v1/users/orders?page=1&limit=10

4. Get orders with status filter:
   GET /api/v1/users/orders?status=pending
   GET /api/v1/users/orders?status=completed&page=2

5. Get order detail:
   GET /api/v1/users/orders/123
